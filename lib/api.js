...
Tuple = {
  ...
  incrementPlayerGameFails: (gameId, playerId) => {
    Games.upsert({
      _id: gameId,
      pid: playerId
    }, {
  ...
  incrementPlayerGameTuples: (gameId, playerId) => {
    Games.upsert({
      _id: gameId,
      pid: playerId
    }, {
