...
Template.leaderboard.helpers({
  cards: function () {
    return Cards.find({}, { sort: { score: -1, name: 1 } });
  },
...
Template.leaderboard.events({
  'click .inc': function () {
    Cards.update(Session.get("selectedPlayer"), {$inc: {score: 5}});
  }
});
...
Template.card.events({
  ...
  //   cards = [],
  //   lastSets = {},
  //   me, lastMsg, preventRefresh = false,
  //   fixwrap, SERVER_EVENTS = ['init', 'join', 'leave', 'rejoin', 'taken', 'setHash', 'remaining', 'puzzled',
  ...
  //   msg({
  //     event: true,
  //     msg: 'Player ' + (winner + 1) + ' has won this round'
  //   });
  //   newGame();
  // }
  //
  ...
  //   msg({
  //     event: true,
  //     msg: ('Attempting to re-connect to the server, next attempt in ' + nextRetry + 'ms')
  //   })
  // }
  //
  ...
  //   msg({
  //     event: true,
  //     msg: 'Reconnect to server FAILED.'
  //   })
  // }
